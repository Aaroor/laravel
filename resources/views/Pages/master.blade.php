...
<body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/">Adora Apparels</a>
            </div>
    ...
    <div class="container">
        ...
        <hr>
            ...
            <footer>
                <div class="row">
                    <div class="col-lg-12">
                        <p>Copyright &copy; Adora Apperals 2015</p>
                    </div>
                </div>
            </footer>
    ...
    <script src="Temp/js/jqBootstrapValidation.js"></script>
    <!--    <script src="Temp/js/contact_me.js"></script>-->
