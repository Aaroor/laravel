...
<header class="main-header">
    ...
    <a href="index2.html" class="logo">
        ...
        <span class="logo-mini" style="font-size: small"><b>A</b>DORA</span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>Adora</b> Apprels</span>
    </a>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <span class="hidden-xs">{{Session::get('key.a')}}</span>
                    </a>
...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            <li class="header">Admin Control Of Adora</li>
            <!-- Optionally, you can add icons to the links -->
             @yield('header_sidebar')

            <!--    <li class="active"><a href="#"><i class="fa fa-home"></i> <span>Home</span></a></li>-->
       <!--     <li><a href="#"><i class="fa fa-list-alt"></i> <span>Cover Page</span></a></li>
            <li><a href="#"><i class="fa fa-list-alt"></i><span>About Page</span></a></li>
            <li><a href="#"><i class="fa fa-list-alt"></i> <span>Contact Page</span></a></li>
            <li><a href="#"><i class="fa fa-list-alt"></i> <span>Contant Page</span></a></li>-->
            <li class="treeview">
